...
### [ ] Task 1.5: Add timeout to execute_query()
...
### [ ] Task 1.6: Fix LIMIT detection regex
...
### [ ] Task 1.7: Fix vector search CTE missing columns
...
### [ ] Task 1.8: Fix embedding pipeline destructive CREATE OR REPLACE
...
### [ ] Task 2.1: Extract shared SQL guard module
...
### [ ] Task 2.2: Auto-discover YAML catalog mappings
...
### [ ] Task 2.3: Fix Dockerfile and container security
...
### [ ] Task 2.4: Defer module-level BQ client initialization
...
### [ ] Task 3.1: Fix online eval with InMemoryRunner
...
### [ ] Task 3.2: Expand ADK built-in evaluation
...
### [ ] Task 3.3: Migrate to autonomous embedding generation
